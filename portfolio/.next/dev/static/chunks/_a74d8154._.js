...
function ThemeProvider(t0) {
    ...
    if ($[0] !== "cf2a5c256680be0b0493e0a7099e9721b8ddfda9be3698b74566b00ab2558bdb") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cf2a5c256680be0b0493e0a7099e9721b8ddfda9be3698b74566b00ab2558bdb";
    }
    const { children } = t0;
    let t1;
    if ($[1] !== children) {
...
//# sourceMappingURL=_a74d8154._.js.map